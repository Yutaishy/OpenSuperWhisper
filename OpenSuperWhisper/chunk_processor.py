...
from . import logger, asr_api, formatter_api
...
class ChunkProcessor:
    ...
    def __init__(
        ...
        self.on_chunk_error: Optional[Callable] = None
    ...
    def retry_chunk(self, chunk_id: int) -> Optional[Future]:
        """
    ...
    def combine_results(self, results: Optional[List[ChunkResult]] = None) -> Tuple[str, str]:
        """
